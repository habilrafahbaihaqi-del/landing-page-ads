...
const pricingData = {
  landingPage: {
    starter: {
      ...
      price: "Rp 999.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/662296e4-a101-4e7f-bd93-f3a95c359cc6",
      message:
    ...
    growth: {
      ...
      price: "Rp 1.499.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/bcc6ebe1-2241-409c-9448-2e65bc153e27",
      message:
    ...
    ultimate: {
      ...
      price: "Rp 2.299.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/fe6798a2-7b5b-43bd-ac6c-801b1269e9a0",
      message:
  ...
  companyProfile: {
    starter: {
      ...
      price: "Rp 1.499.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/fed734c9-26e4-474f-8f0f-92069a0d9fdb",
      message:
    ...
    growth: {
      ...
      price: "Rp 2.499.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/e0c5e190-5ae7-42ca-8203-7d208b56fdb3",
      message:
    ...
    ultimate: {
      ...
      price: "Rp 2.999.000",
      paymentLink:
        "https://app.sandbox.midtrans.com/payment-links/b855ed42-6834-49e4-a34f-21fdc87bba14",
      message:
...
function updatePricing() {
  ...
  // ---> UPDATE LINK TOMBOL KE MIDTRANS <---
  document.getElementById("wa-starter").href = data.starter.paymentLink;
  document.getElementById("wa-growth").href = data.growth.paymentLink;
  document.getElementById("wa-ultimate").href = data.ultimate.paymentLink;
